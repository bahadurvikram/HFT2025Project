execute_one_at_a_time <- function(data, volat.sd, m_, spread_name, strategy_name) {
  #spread_name like spread_avratio or spread_sdsratio
  #strategy_name like mr or mom
  message(paste0("volat.sd = ", volat.sd, ", m_ = ", m_, " spread_name = ", spread_name, " strategy_name = ", strategy_name)) 
  require(xts)
  require(quantmod)
  require(chron)
  require(TTR)
  ...
  signal <- coredata(data[,spread_name])
